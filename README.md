...
# 📖 [Money-Minder] <a name="about-project"></a>
...
```sh
  cd my-folder
  git clone git@github.com:KareemWilson/money-minder.git
```
...
I would like to thank [Gregoire Vella on Behance.](https://www.behance.net/gregoirevella) for design contributed into this project
